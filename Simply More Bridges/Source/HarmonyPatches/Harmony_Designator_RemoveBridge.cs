...
namespace SimplyMoreBridges
{
    ...
    public class Harmony_Designator_RemoveBridge_CanDesignateCell
    {
        ...
        private static bool DesignateCellHelper(IntVec3 c, Map map)
        {
            ...
            DesignatorDropdownGroupDef ddgd = c.GetTerrain(map).designatorDropdown;
            return ddgd == DesignatorDropdownGroupDefOf.Bridge_Heavy || ddgd == DesignatorDropdownGroupDefOf.Bridge_DeepWater;
        }
